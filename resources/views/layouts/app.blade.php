...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('logos and images/Kisaan world-transparent.png') }}">
    ...
    <link rel="preload" as="image" href="{{ asset('logos and images/Kisaan world-transparent.png') }}" fetchpriority="high">
    <x-frontend-assets />
    @yield('head')
    @stack('head')
</head>
